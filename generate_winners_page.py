...
trophies = [
    ...
    {"id": "eric_timon", "name": "Eric Timon Cup", "category": "community", "image": "EricTimonCup.jpg",
...
<div class="l-container">
    <div class="entry-content">
        ...
        <div style="text-align: center; margin-bottom: 20px; padding: 15px; background: var(--color-bg-secondary); border-radius: 8px;">
            <a href="{{ SITEURL }}/archive/artifacts/trophy-donors.html" style="font-weight: bold; color: var(--primary-color); text-decoration: none;">📖 Read about the Trophies and their Donors here (Coming Soon)</a>
        </div>
        
        <div style="text-align: center; margin-bottom: 30px;">
            <a href="{{ SITEURL }}/archive/artifacts/prizegiving/index.html" class="filter-btn" style="background-color: var(--primary-color); color: white; text-decoration: none; border-color: var(--primary-color); display: inline-block; padding: 10px 20px; font-weight: bold;">📸 View Prizegiving Galleries</a>
        </div>
...
"""
    ...
    for t in trophies:
        article_html = f'<p style="margin-top: 15px;"><a href="{{{{ SITEURL }}}}/{t["article_link"]}" style="background-color: var(--primary-color); color: white; padding: 8px 16px; text-decoration: none; border-radius: 4px; font-weight: bold; display: inline-block;">📖 Read Full Article</a></p>' if 'article_link' in t else ''
